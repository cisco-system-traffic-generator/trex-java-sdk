...
import com.cisco.trex.stateful.api.lowlevel.ASTFGlobalInfo;
import com.cisco.trex.stateful.api.lowlevel.ASTFGlobalInfoBase;
...
public class AstfTestUtil {
  ...
  public static void tuneTcp(int mass) {
    ...
    gInfo.tcp(ASTFGlobalInfoBase.TcpParam.NO_DELAY, 1);
    gInfo.tcp(ASTFGlobalInfoBase.TcpParam.RX_BUF_SIZE, 512 * 1024);
    gInfo.tcp(ASTFGlobalInfoBase.TcpParam.TX_BUF_SIZE, 512 * 1024);
    gInfo.tcp(ASTFGlobalInfoBase.TcpParam.DO_RFC1323, 0);
  }
