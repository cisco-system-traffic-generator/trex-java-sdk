...
public class IPv6NeighborDiscoveryService {
  ...
  public EthernetPacket sendIcmpV6Echo(int portIdx, String srcMac, String dstIp, int icmpId,
      int icmpSeq, int timeOut) {
  ...
  public EthernetPacket sendNeighborSolicitation(int portIdx, int timeout, String srcMac,
      String dstIp) {
